...
if (isset($_POST['submit'])) {
    ...
    if (isset($ten) && isset($email) && isset($sdt) && isset($diachi)) {
        ...
        // Phải chỉnh sửa lại
        $mailer->Username = "apple.web.ltp@gmail.com"; // GMAIL username
        $mailer->Password = "olgupetyfqllhbjq"; // GMAIL password
        $mailer->AddAddress($email, $ten); //email người nhận, $email và $ten là 2 biến đc gán bởi $_POST lấy từ trong form
        $mailer->AddCC("apple.web.ltp@gmail.com", "Admin Apple LTP"); // gửi thêm một email cho Admin

        // Chuẩn bị gửi thư nào
        $mailer->FromName = 'Apple LTP'; // tên người gửi
        $mailer->From = 'apple.web.ltp@gmail.com'; // mail người gửi
        $mailer->Subject = 'Hóa đơn xác nhận mua hàng từ Apple LTP';
