            ...
            <div class="panel-body">
                ...
                <form method="post" enctype="multipart/form-data" role="form">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>Đi kèm</label>
                            <input type="text" class="form-control" name="phu_kien" value="Hộp, sách hướng dẫn, sạc, cáp, tai nghe">
                        </div>
                        <div class="form-group">
                            <label>Tình trạng</label>
                            <input type="text" class="form-control" name="tinh_trang" value="Mới 100%" required="">
                        </div>
